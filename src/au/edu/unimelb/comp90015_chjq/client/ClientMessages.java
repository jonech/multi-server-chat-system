...
public class ClientMessages {
	...
	public static JSONObject getLoginRequest(String account, String password, String accessToken) {
		JSONObject newIdentity = new JSONObject();
		newIdentity.put("type", "login");
		newIdentity.put("account", account);
		newIdentity.put("password", password);
		newIdentity.put("accessToken", accessToken);
		return newIdentity;
	}
